...
const DefaultLayout = (props: Props) => {
  ...
  const [showForm, setShowForm] = React.useState<string>("-translate-x-full");
  ...
  <div className="px-3 py-3 lg:px-5 lg:pl-3">
    <div className="flex items-center justify-between">
      <div className="flex items-center justify-start">
        <button  onClick={()=>{
               if(showForm=="-translate-x-full"){
                 setShowForm("")

              }
              else{
               setShowForm("-translate-x-full")
      ...
      <ul className="space-y-2 font-medium">
         ...
         <li>
            ...
            <a  href={`/api/auth/signin`}   onClick={(e) => {
                  e.preventDefault()
                  signIn()}} className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
            ...
            {session && (
               <a href={`/api/auth/signout`} onClick={(e) => {
                  e.preventDefault()
                  signOut()}} className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
               <svg aria-hidden="true" className="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M5 4a3 3 0 00-3 3v6a3 3 0 003 3h10a3 3 0 003-3V7a3 3 0 00-3-3H5zm-1 9v-1h5v2H5a1 1 0 01-1-1zm7 1h4a1 1 0 001-1v-1h-5v2zm0-4h5V8h-5v2zM9 8H4v2h5V8z" clip-rule="evenodd"></path></svg>
...
<div className='p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-14 sm:ml-64'>
{props.children}
</div>
