...
const ProductCard = (props: Props) => {
  ...
  <div className="mt-4 px-5 pb-5">
    ...
    <a href="#" className="flex items-center justify-center rounded-md bg-red-700 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-blue-300">
